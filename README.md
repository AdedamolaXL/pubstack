...
Check out the [live demo](https://youtu.be/DrwDdtCmXGw) first to see what to expect! and the link to the [server code](https://github.com/AdedamolaXL/pubstack-server-node) if you are feeling geeky :)
