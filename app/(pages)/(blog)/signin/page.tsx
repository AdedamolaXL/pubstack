...
const blogPosts = [
    ...
    excerpt: 'If you have readers across the world, you need to consider integrating crypto payments..',
    date: '2025-08-20',
    readTime: '11 min read',
    category: 'Monetization',
    image: 'https://images.unsplash.com/photo-1608286022625-bc07f7a21154?auto=format&fit=crop&w=600&h=400&q=80',
    tags: ['web3', 'blockchain', 'independent authors']
  },
  {
    id: '2',
    title: 'The Art of Building Fictional Worlds',
    excerpt: 'Exploring how I create immersive worlds...',
    date: '2025-07-15',
    readTime: '8 min read',
    category: 'Writing Process',
    image: 'https://images.unsplash.com/photo-1618393678108-820a9d6e41ed?auto=format&fit=crop&w=600&h=400&q=80',
    tags: ['world-building', 'writing tips', 'fiction']
  },
  {
    id: '3',
    title: 'Why I Write Speculative Fiction',
    excerpt: 'A personal reflection on my journey into speculative fiction...',
    date: '2025-06-08',
    readTime: '6 min read',
  ...
  },
  {
    ...
    excerpt: 'Maintaining consistency across multiple books...',
    date: '2025-05-01',
  ...
  },
  {
    ...
    excerpt: 'Practical strategies I use when facing creative blocks...',
    date: '2025-04-24',
    readTime: '7 min read',
    category: 'Writing Tips',
    image: 'https://images.unsplash.com/photo-1587428601833-2d8b4157b6c4?auto=format&fit=crop&w=600&h=400&q=80',
    tags: ['writer\'s block', 'productivity', 'creativity']
  },
  {
    id: '6',
    title: 'The Role of Research in Fiction Writing',
    excerpt: 'How much research is too much?',
    date: '2025-03-17',
    readTime: '9 min read',
    category: 'Writing Process',
...
export default function Blog() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="w-full px- py-7">

        {/* Blog Header */}
        <div className="text-center mb-10 max-w-4xl mx-auto">
          <h1 className="text-4xl font-sans font-bold text-dune-900 mt-2 mb-8">Storytelling 101</h1>
        ...
        <div className="flex flex-col xl:flex-row gap- mb-12 w-full max-w-[1920px] mx-auto">
          {/* Left Column - Most Popular */}
          <div className="xl:w-1/4 xl:pl-6">
            <h2 className="text-2xl font-sans font-bold text-primary-600 mb-6 pb-2 border-b border-gray-200">Most Popular</h2>
            <div className="space-y-6">
              {mostPopularPosts.map((post) => (
                <article key={post.id} className="bg-white rounded-lg border border-gray-200 overflow-hidden hover:shadow-md transition-shadow duration-300">
                  ...
                  <div className="p-4">
                    <h3 className="text-lg font-sans font-semibold text-dune-900 mt-1 mb-2 hover:text-primary-600 transition-colors">
                       <div>{post.title}</div>
                    </h3>
          ...
          <div className="xl:w-2/4 xl:px-8">
            <h2 className="text-2xl font-sans font-bold text-primary-600 mb-6 pb-2 border-b border-gray-200 text-center">New</h2>
            <article className="bg-white rounded-lg border border-gray-200 overflow-hidden hover:shadow-md transition-shadow duration-300">
              ...
              <div className="p-8">
                <div className="flex items-center justify-between mb-4">
                 ...
                 <h3 className="text-2xl font-sans font-bold text-dune-700 mb-4 hover:text-primary-600 transition-colors">
                  <Link href="/">{newPost.title}</Link>
                </h3>
                <p className="text-dune-700 mb-6 text-sm">{newPost.excerpt}</p>
                <div className="flex items-center justify-between">
          ...
          <div className="xl:w-1/4 xl:pr-6">
            <h2 className="text-2xl font-sans font-bold text-primary-600 mb-6 pb-2 border-b border-gray-200 text-right">Recents</h2>
        ...
        <div className="flex flex-col xl:flex-row gap-8 w-full max-w-[1920px] mx-auto">
          ...
          <div className="xl:w-3/4 xl:pl-6">
          ...
          <div className="xl:w-1/4 xl:pl-">
            {/* About the Author */}
            <div className="bg-white rounded-lg border border-gray-200 p-6 mt-10">
              <h3 className="text-lg font-sans font-semibold text-dune-900 mb-6">About the Author</h3>
              <div className="flex items-center mb-6">
                <div className="p- rounded-full bg-primary-100 text-primary-600 mr-4">
                  <UserCircleIcon className="h-10 w-10" />
                </div>
                <div>
                  <p className="font-medium text-dune-900">D.R Storyweaver</p>
